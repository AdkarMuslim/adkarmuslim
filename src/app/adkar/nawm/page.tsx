...
import dhikrsData from "../../../../data/adkar-nawm.json";
...
const STORAGE_KEY = "am_adkar_nawm_v1";
...
export default function AdkarNawmPage() {
  ...
  const onShare = async () => {
    const text = "أذكار النوم - اللهم باسمك أموت وأحيا.";
    try {
      if (navigator.share) {
    ...
    <main className="mx-auto w-full max-w-3xl px-2 pb-6">
      <section className="glass-panel ring-accent/0 p-5 sm:p-7">
        <div className="flex items-start justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-white sm:text-3xl">أذكار النوم</h1>
            <p className="mt-3 text-sm leading-relaxed text-white/75">
              أذكار النوم مكتوبة كاملة لتختم بها يومك بطمأنينة: آيات وأدعية قبل النوم ضمن حصن المسلم، مع عداد يبقي
              تقدّمك واضحاً.
            </p>
