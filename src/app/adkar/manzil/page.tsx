...
import dhikrsData from "../../../../data/adkar-manzil.json";
...
const STORAGE_KEY = "am_adkar_manzil_v1";
...
export default function AdkarManzilPage() {
  ...
  const onShare = async () => {
    const text = "أذكار المنزل - أكملت جزءًا منها اليوم. بارك الله فيك.";
    try {
