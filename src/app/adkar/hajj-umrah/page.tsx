...
import dhikrsData from "../../../../data/adkar-hajj-umrah.json";
...
const STORAGE_KEY = "am_adkar_hajj_umrah_v1";
...
export default function HajjUmrahAdkarPage() {
  ...
  const onShare = async () => {
    const text = "أذكار الحج والعمرة - ذكّرني بما حفظت اليوم.";
    try {
