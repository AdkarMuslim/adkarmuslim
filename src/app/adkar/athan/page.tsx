...
import dhikrsData from "../../../../data/adkar-athan.json";
...
const STORAGE_KEY = "am_adkar_athan_v1";
...
export default function AdkarAthanPage() {
  ...
  const onShare = async () => {
    const text = "أذكار الآذان - أذكار عند سماع الأذان وما بعده.";
    try {
