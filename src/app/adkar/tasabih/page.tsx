...
import dhikrsData from "../../../../data/adkar-tasabih.json";
...
const STORAGE_KEY = "am_adkar_tasabih_v1";
...
export default function AdkarTasabihPage() {
              ...
              >
                <div className="flex flex-col gap-4">
                  <div className="min-w-0">
                    <div className="flex items-center gap-2">
                      <div className="text-[11px] text-white/55">التسبيح {idx + 1}</div>
                      {completed ? (
                  ...
                  <div className="flex flex-col items-stretch gap-2">
                    ...
                    <button
                      ...
                      aria-label="زيادة العدّ لهذا التسبيح"
                    >
                      {done} / {target}
                    </button>
