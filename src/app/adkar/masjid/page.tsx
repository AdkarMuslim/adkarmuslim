...
import dhikrsData from "../../../../data/adkar-masjid.json";
...
const STORAGE_KEY = "am_adkar_masjid_v1";
...
export default function AdkarMasjidPage() {
  ...
  const onShare = async () => {
    const text = "أذكار المسجد - أكملت جزءًا منها اليوم. بارك الله فيك.";
    try {
    ...
    <main className="mx-auto w-full max-w-3xl px-2 pb-6">
      <section className="glass-panel ring-accent/0 p-5 sm:p-7">
        <div className="flex items-start justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-white sm:text-3xl">أذكار المسجد</h1>
            <p className="mt-3 text-sm leading-relaxed text-white/75">
              أذكار المسجد مكتوبة كاملة: الدخول والخروج والصلاة فيه وآداب بيت الله، مع عداد تفاعلي لمراجعة أذكارك
              بسهولة.
            </p>
        ...
        <ContentPageFooter
          ...
          related={[
            { href: "/adkar/wudoo", label: "أذكار الوضوء" },
            { href: "/adkar/athan", label: "أذكار الأذان" },
