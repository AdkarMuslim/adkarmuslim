...
import dhikrsData from "../../../../data/adkar-salat.json";
...
const STORAGE_KEY = "am_adkar_salat_v1";
...
export default function AdkarSalatPage() {
  ...
  const onShare = async () => {
    const text = "أذكار بعد الصلاة - تقبّل الله.";
    try {
      if (navigator.share) {
