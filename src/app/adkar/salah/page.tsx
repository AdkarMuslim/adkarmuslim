...
export default function AdkarSalahPage() {
  ...
  const onShare = async () => {
    const text = "أذكار الصلاة - تقبّل الله صلاتكم.";
    try {
      if (navigator.share) {
    ...
    <main className="mx-auto w-full max-w-3xl px-2 pb-6">
      <section className="glass-panel ring-accent/0 p-5 sm:p-7">
        <div className="flex items-start justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-white sm:text-3xl">أذكار الصلاة</h1>
            <p className="mt-3 text-sm leading-relaxed text-white/75">
              أذكار الصلاة مكتوبة كاملة من التكبير والاستفتاح إلى الركوع والسجود والتشهد: نصوص من السنة مع عداد
              يذكّرك بعدد كل ذكر أثناء الصلاة.
            </p>
              ...
              >
                <div className="flex flex-col gap-4">
                  <div className="min-w-0">
                    ...
                    <div className="mt-2 max-h-[42vh] w-full overflow-auto overscroll-contain whitespace-pre-line rounded-2xl border border-white/10 bg-white/5 p-4">
                  ...
                  <div className="flex flex-col items-stretch gap-2">
                    ...
                    <div className="text-[11px] text-white/55">اضغط على الزر حتى تُكمل {formatCountTarget(target)}.</div>
