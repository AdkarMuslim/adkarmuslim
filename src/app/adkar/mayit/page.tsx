    ...
    <main className="mx-auto w-full max-w-3xl px-2 pb-6">
      <section className="glass-panel ring-accent/0 p-5 sm:p-7">
        <div className="flex items-start justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-white sm:text-3xl">أدعية للميّت</h1>
            <p className="mt-2 text-sm text-white/60">أدعية للميت، مع دعاء صلاة الجنازة ودعاء الطفل.</p>
          </div>
