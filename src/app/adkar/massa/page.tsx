...
import dhikrsData from "../../../../data/adkar-massa.json";
...
const STORAGE_KEY = "am_adkar_masaa_v1";
...
export default function AdkarMassaPage() {
  ...
  const onShare = async () => {
    const text = "أذكار المساء - اللهم اجعلها في ميزان الحسنات.";
    try {
      if (navigator.share) {
