...
import dhikrsData from "../../../../data/adkar-khalaa.json";
...
const STORAGE_KEY = "am_adkar_khalaa_v1";
...
export default function AdkarKhalaaPage() {
  ...
  const onShare = async () => {
    const text = "أذكار الخلاء - أكملت جزءًا منها اليوم. بارك الله فيك.";
    try {
    ...
    <main className="mx-auto w-full max-w-3xl px-2 pb-6">
      <section className="glass-panel ring-accent/0 p-5 sm:p-7">
        <div className="flex items-start justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-white sm:text-3xl">أذكار اللباس</h1>
            <p className="mt-3 text-sm leading-relaxed text-white/75">
              أذكار لباس الثوب وخلعه مكتوبة كاملة من الأدعية المأثورة، مع عداد يبسّط التكرار والمراجعة اليومية.
            </p>
