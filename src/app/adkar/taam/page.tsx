...
import dhikrsData from "../../../../data/adkar-taam.json";
...
const STORAGE_KEY = "am_adkar_taam_v1";
...
export default function AdkarTaamPage() {
  ...
  const onShare = async () => {
    const text = "أذكار الطعام - أكملت جزءًا منها اليوم. بارك الله فيك.";
    try {
    ...
    <main className="mx-auto w-full max-w-3xl px-2 pb-6">
      <section className="glass-panel ring-accent/0 p-5 sm:p-7">
        <div className="flex items-start justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-white sm:text-3xl">أذكار الطعام والشراب</h1>
            <p className="mt-3 text-sm leading-relaxed text-white/75">
              أذكار الطعام والشراب مكتوبة كاملة: بسم الله وأذكار قبل وبعد الأكل والضيافة من السنة، مع عداد تفاعلي.
            </p>
        ...
        <SeoContentFooter
          section="adkar"
          related={[
            { href: "/adkar/khalaa", label: "أذكار اللباس" },
