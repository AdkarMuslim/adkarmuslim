  ...
  return (
    <>
      ...
      <LegalArticle title="سياسة الخصوصية">
        ...
        <p>
          قد يخزّن الموقع بعض الإعدادات داخل{" "}
          <strong className="text-white/90">متصفحك فقط</strong> (مثل تفضيلات أوقات الصلاة أو المظهر
          إن اخترت حفظها عبر localStorage). عدادات الأذكار في الجلسة الحالية فقط ولا تُحفظ بعد تحديث
          الصفحة. لا نرسل هذه البيانات تلقائياً إلى خوادمنا كجزء من تسجيل حساب — الموقع لا يفرض إنشاء
          حساب لاستخدامه الأساسي.
        </p>
